...
const { argv } = yargs(process.argv.slice(2))
	.command("spectrum-css", "A utility for working with Spectrum CSS")
	.usage(
    `Usage:
  $0 [build|report] [input.css] [OPTIONS] [-o|--output output.css] [--watch|-w]
  $0 [build|report] <input.css>... [OPTIONS] --dir <output-directory> [--watch|-w]
  $0 [build|report] <input-directory> [OPTIONS] --dir <output-directory> [--watch|-w]
  $0 [build|report] <input-glob-pattern> [OPTIONS] --dir <output-directory> [--watch|-w]
  $0 [build|report] <input.css>... [OPTIONS] --replace`,
	)
	.positional("command", {
